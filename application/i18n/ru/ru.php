...
return array(
    ...
    ':field must be the same as :param3'                   => ':field и :param3 не должны отличатся',
    ...
    ':field not selected.'                                 => ':field не выбрано'    ,
    ':field not valid picture file.'                       => ':field имеет не верный тип загружаемого файла',

    'user'                                                 => 'Поле Юзер',
    'email'                                                => 'Поле Емейл',
    'message'                                              => 'Поле Текст сообщения',
    'gift name'                                            => 'Поле "Название подарка"',
    'gift url'                                             => 'Поле "Ссылка на подарок"',
    'gift priority'                                        => 'Поле "Приоритет"',
    'option name'                                          => 'Поле "Машинное название опции"',
    'option name ru'                                       => 'Поле "Название опции"',
    'option value'                                         => 'Поле "Значение"',
    
    'password' => 'Значение поля пароль',
    'password confirm' => 'Значение поля подтверждение пароля',
);